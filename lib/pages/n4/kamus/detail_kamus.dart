...
class DetailKamusPage extends StatefulWidget {
  final Map<String, dynamic> item;

  const DetailKamusPage({super.key, required this.item});

  @override
  State<DetailKamusPage> createState() => _DetailKamusPageState();
}

class _DetailKamusPageState extends State<DetailKamusPage> {
  @override
