...
import 'package:bahasajepang/pages/n5/kanji/kanji%20tandoku/model/kanji_api.model.dart';

class DetailApiPage extends StatefulWidget {
  const DetailApiPage({super.key});
...
class _DetailApiPageState extends State<DetailApiPage> {
  final Map<String, dynamic> kanjiData = detailApiList[0];
