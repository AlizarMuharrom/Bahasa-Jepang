import 'package:bahasajepang/pages/n5/kanji/kanji%20tandoku/model/kanji_buku.model.dart';
import 'package:flutter/material.dart';

class DetailBukuPage extends StatefulWidget {
  DetailBukuPage({super.key});
...
class _DetailBukuPageState extends State<DetailBukuPage> {
  final Map<String, dynamic> kanjiData = detailBukuList[0];
