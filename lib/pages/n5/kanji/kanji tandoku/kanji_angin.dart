...
import 'package:bahasajepang/pages/n5/kanji/kanji%20tandoku/model/kanji_angin.model.dart';

class DetailAnginPage extends StatefulWidget {
  const DetailAnginPage({super.key});

  @override
  State<DetailAnginPage> createState() => _DetailAnginPageState();
}

class _DetailAnginPageState extends State<DetailAnginPage> {
  final Map<String, dynamic> kanjiData = detailAnginList[0];
