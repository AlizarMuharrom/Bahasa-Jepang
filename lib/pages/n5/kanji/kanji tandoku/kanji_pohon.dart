...
import 'package:bahasajepang/pages/n5/kanji/kanji%20tandoku/model/kanji_pohon.model.dart';

class DetailPohonPage extends StatefulWidget {
  const DetailPohonPage({super.key});

  @override
  State<DetailPohonPage> createState() => _DetailPohonPageState();
}

class _DetailPohonPageState extends State<DetailPohonPage> {
  final Map<String, dynamic> kanjiData = detailPohonList[0];
