...
import 'package:bahasajepang/pages/n5/kanji/kanji%20tandoku/model/kanji_hari.model.dart';

class DetailHariPage extends StatefulWidget {
  const DetailHariPage({super.key});

  @override
  State<DetailHariPage> createState() => _DetailHariPageState();
}

class _DetailHariPageState extends State<DetailHariPage> {
  final Map<String, dynamic> kanjiData = detailHariList[0];
